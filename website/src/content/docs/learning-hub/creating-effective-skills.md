...
copilot skill add ./my-skill/ --project # add a skill scoped to this repository
...
> **Note (v1.0.85+)**: `copilot skill add [--project]` replaces the older `copilot plugins install --skill [--scope project]` syntax; the `--scope` spelling has been removed.
